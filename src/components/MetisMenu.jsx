...
class MetisMenu extends React.Component {
  constructor(props) {
    ...
    this.classStore = {
      ...
      classSubContainer: classnames(
        { 'metismenu-sub-container': !props.noBuiltInClassNames },
        props.classNameSubContainer
      ),
      classSubContainerVisible: classnames(
        { visible: !props.noBuiltInClassNames },
        props.classNameSubContainerVisible
      ),
...
MetisMenu.propTypes = {
  ...
  classNameSubContainer: PropTypes.string,
  classNameSubContainerVisible: PropTypes.string,
  ...
  classNameItemHeader: PropTypes.string,
  classNameItemDivider: PropTypes.string,
